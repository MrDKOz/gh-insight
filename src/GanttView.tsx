...
import { fmtDate, itemEndDate } from './utils';
...
export default function GanttView({
  sortedItems, milestones, isMultiMilestone, milestoneColorMap, hasOpenIssues,
  labelWidth, axisHeight, trackWidth, minTime, totalMs, todayMs,
  trackColRef, axisRef, onResizeStart,
}: Props) {
