...
// ── Demo epics (acme/frontend) ────────────────────────────────────────────────

const DEMO_EPIC_AUTH: Epic = {
  number: 500,
  title: "Authentication overhaul",
  state: "open",
  subIssueCount: 4,
  url: "https://github.com/demo/repo/issues/500",
};

const DEMO_EPIC_PERF: Epic = {
  number: 501,
  title: "Performance initiative",
  state: "open",
  subIssueCount: 3,
  url: "https://github.com/demo/repo/issues/501",
};

const DEMO_EPIC_AUTH_ITEMS: TimelineItem[] = [
  {
    type: "issue",
    number: 501,
  ...
  },
  {
    type: "pr",
    number: 601,
    title: "feat: PKCE + state validation in OAuth handler",
    url: "https://github.com/demo/repo/pull/601",
    author: "gaearon",
    createdAt: d(33, 10),
    updatedAt: d(30, 13),
    mergedAt: d(30, 13),
    ...
    labels: [{ name: "auth", color: "#e4e669" }],
    assignees: ["gaearon"],
    firstReviewAt: d(31, 15),
  },
  {
    type: "issue",
    number: 502,
    title: "Add WebAuthn passkey support",
    url: "https://github.com/demo/repo/issues/502",
    author: "torvalds",
    createdAt: d(35, 10),
    updatedAt: d(18, 11),
    closedAt: d(18, 11),
    linkedPRs: [602],
    milestoneNumber: 500,
    labels: [{ name: "auth", color: "#e4e669" }, { name: "feature", color: "#0075ca" }],
    assignees: ["torvalds"],
    reopenedCount: 0,
  },
  {
    type: "pr",
    number: 602,
    title: "feat: WebAuthn registration and assertion flows",
    url: "https://github.com/demo/repo/pull/602",
    author: "torvalds",
    createdAt: d(23, 9),
    updatedAt: d(18, 10),
    mergedAt: d(18, 10),
  ...
  },
  {
    type: "issue",
    number: 503,
    title: "MFA recovery codes and backup flow",
    url: "https://github.com/demo/repo/issues/503",
    author: "sindresorhus",
    createdAt: d(20, 9),
    updatedAt: d(5),
    closedAt: null,
    linkedPRs: [],
    milestoneNumber: 500,
    labels: [{ name: "auth", color: "#e4e669" }, { name: "security", color: "#e11d48" }],
    assignees: ["sindresorhus"],
    reopenedCount: 0,
  },
  {
    ...
    url: "https://github.com/demo/repo/issues/504",
    author: "addyosmani",
    createdAt: d(15, 10),
    updatedAt: d(3),
    closedAt: null,
...
const DEMO_EPIC_PERF_ITEMS: TimelineItem[] = [
  {
    type: "issue",
    number: 510,
    title: "Bundle size audit and code-splitting plan",
    url: "https://github.com/demo/repo/issues/510",
    author: "addyosmani",
    createdAt: d(50, 9),
    updatedAt: d(38, 12),
    closedAt: d(38, 12),
  ...
  },
  {
    type: "pr",
    number: 610,
    title: "perf: dynamic import for all route components",
    url: "https://github.com/demo/repo/pull/610",
    author: "addyosmani",
    createdAt: d(43, 10),
    updatedAt: d(38, 11),
    mergedAt: d(38, 11),
    ...
    labels: [{ name: "performance", color: "#fbca04" }],
    assignees: ["addyosmani"],
    firstReviewAt: d(40, 14),
  },
  {
    type: "issue",
    number: 511,
    title: "Virtualise long lists in dashboard tables",
    url: "https://github.com/demo/repo/issues/511",
    author: "tj",
    createdAt: d(42, 10),
    updatedAt: d(28, 13),
    closedAt: d(28, 13),
    linkedPRs: [611],
    milestoneNumber: 501,
    labels: [{ name: "performance", color: "#fbca04" }, { name: "ux", color: "#c5def5" }],
    assignees: ["tj"],
    reopenedCount: 0,
  },
  {
    type: "pr",
    number: 611,
    title: "perf: TanStack Virtual for large data tables",
    url: "https://github.com/demo/repo/pull/611",
    author: "tj",
    createdAt: d(34, 9),
    updatedAt: d(28, 12),
    mergedAt: d(28, 12),
    ...
    labels: [{ name: "performance", color: "#fbca04" }],
    assignees: ["tj"],
    firstReviewAt: d(30, 11),
  },
  {
    type: "issue",
    number: 512,
    title: "Service worker for offline asset caching",
    url: "https://github.com/demo/repo/issues/512",
    author: "gaearon",
    createdAt: d(25, 9),
    updatedAt: d(7),
    closedAt: null,
    linkedPRs: [],
    milestoneNumber: 501,
    labels: [{ name: "performance", color: "#fbca04" }, { name: "offline", color: "#c5def5" }],
    assignees: ["gaearon"],
    reopenedCount: 0,
  },
];
...
const DEMO_DATA_BY_REPO: Record<string, {
  milestones: Milestone[];
  items: Record<number, TimelineItem[]>;
  epics?: Epic[];
  epicItems?: Record<number, TimelineItem[]>;
}> = {
  "acme/frontend": {
    ...
    epics: [DEMO_EPIC_AUTH, DEMO_EPIC_PERF],
    epicItems: {
      [DEMO_EPIC_AUTH.number]: DEMO_EPIC_AUTH_ITEMS,
      [DEMO_EPIC_PERF.number]: DEMO_EPIC_PERF_ITEMS,
    },
  },
  "acme/backend": {
